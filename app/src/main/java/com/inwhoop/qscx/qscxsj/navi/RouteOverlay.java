...
public class RouteOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        View view = View.inflate(mContext, R.layout.marker_start, null);
    ...
    protected BitmapDescriptor getEndBitmapDescriptor() {
        View view = View.inflate(mContext, R.layout.marker_end, null);
        return BitmapDescriptorFactory.fromView(view);
    }
    ...
    protected BitmapDescriptor getBusBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.icon_position_cj2);
    }
    ...
    protected int getDriveColor() {
        return ContextCompat.getColor(mContext, R.color.traffic_green);
    }
