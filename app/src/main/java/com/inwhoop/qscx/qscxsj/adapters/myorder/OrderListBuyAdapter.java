 ...
 * 代买订单列表
 */
public class OrderListBuyAdapter extends CommonBaseAdapter<TownOrderBean> {

    public OrderListBuyAdapter(Context context, List<TownOrderBean> datas) {
    ...
    protected void convert(ViewHolder holder, final TownOrderBean data, int position, String payload) {
        holder.setImageThumb(R.id.iv_head, data.getHead_img()).setText(R.id.tv_name, data.getName())
                ...
                .setText(R.id.tv_location, TextUtils.isEmpty(data.getStart_location()) ? "附近地点" : data.getStart_location())
