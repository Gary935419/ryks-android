...
public class L {
    ...
    public static void i(String tag, String msg, Throwable tr) {
        if (Constants.IS_DEBUG) {
            println(Log.INFO, tag, msg, tr, true);
        }
    }
    ...
    public static void d(String tag, String msg, Throwable tr) {
        if (Constants.IS_DEBUG) {
            println(Log.DEBUG, tag, msg, tr, true);
        }
    }
    ...
    public static void w(String tag, String msg, Throwable tr) {
        if (Constants.IS_DEBUG) {
            println(Log.WARN, tag, msg, tr, true);
        }
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        if (Constants.IS_DEBUG) {
            println(Log.ERROR, tag, msg, tr, true);
        }
    }
    ...
    public static void v(String tag, String msg, Throwable tr) {
        if (Constants.IS_DEBUG) {
            println(Log.VERBOSE, tag, msg, tr, true);
        }
    }
    ...
    public static void net(String tag, String msg) {
        if (Constants.IS_DEBUG) {
            println(Log.WARN, tag, msg, null, false);
        }
    }

    private final synchronized static void println(int priority, String tag, String msg, Throwable tr, boolean showLine) {
        if (Constants.IS_DEBUG) {
            if (showLine) {
                StackTraceElement targetStackTraceElement = getTargetStackTraceElement();
                Log.println(priority, tag, "(" + targetStackTraceElement.getFileName() + ":" + targetStackTraceElement.getLineNumber() + ")");
            }
